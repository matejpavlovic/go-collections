...
// ValuesOf returns a slice containing the values from map m corresponding to the provided keys, in the same order
// as the keys.
...
// KeysAndValues returns a slice containing all keys of map m (in arbitrary order) and a slice containing the
